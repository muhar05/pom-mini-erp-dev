          ...
          style={
            {
              ...
              backgroundColor: "var(--card)", // sama seperti desktop
              color: "var(--foreground)", // teks sama desktop
            } as React.CSSProperties
          }
          side={side}
        >
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground flex h-7 min-w-0 -translate-x-px items-center gap-2 rounded-md px-2 outline-hidden focus-visible:ring-2",
