import EmailSidebar from "@/app/(protected)/(dashboard)/components/email-sidebar";
import EmailSidebarOverlay from "@/app/(protected)/(dashboard)/components/email-sidebar-overlay";
import EmailSidebarToggleButton from "@/app/(protected)/(dashboard)/email/components/email-sidebar-toggle-button";
              ...
              <div className="">
                <div className="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-[#273142] py-4 px-6 flex items-center gap-3 justify-between flex-wrap">
                  <div className="flex items-center gap-2">
                    <Link
                      href="/email"
                      className="!p-0 text-neutral-600 dark:text-white flex me-2 hover:text-primary"
                    >
                      <MoveLeft />
                    </Link>
                    <h6 className="mb-0 text-lg">Kathryn Murphy</h6>
                    <span className="bg-blue-100 dark:bg-primary/25 text-primary dark:text-blue-400 text-sm rounded px-2">
                      Personal
                    </span>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="">
                        <div className="flex items-center flex-wrap gap-2">
                          <h6 className="mb-0 text-lg">Kathryn Murphy</h6>
                          <span className="text-neutral-600 dark:text-white text-base">
                        ...
                        <div className="mt-5">
                          ...
                          <p className="mb-4 text-neutral-600 dark:text-neutral-200">
                            Just confirming that we transferred $63.86 to you
                            via PayPal{" "}
                            <Link
                              href="#"
                            ...
                            which you earned on the themewow Market since your
                            last payout.
                          </p>
                          <p className="mb-0 text-neutral-600 dark:text-neutral-200">
              ...
              <div className="card-footer py-4 px-6 bg-white dark:bg-[#273142] border-t border-neutral-200 dark:border-neutral-600">
                <form action={sendMessageAction}>
                  <div className="flex items-center justify-between">
                    <Textarea
                      className="max-h-[80px] bg-transparent focus:ring-0 w-full p-0 rounded-lg border-0 py-2 ps-2 resize-none scroll-sm focus-visible:ring-0"
                      id="message"
                      name="message"
                    ...
                    <div className="flex items-center gap-4 ms-4">
                      <div className="">
                        <Label
                          htmlFor="attachment"
                          className="text-neutral-600 text-xl dark:text-white cursor-pointer hover:text-primary"
                        >
