        ...
        <div className="md:col-span-6 col-span-12">
          <DefaultCardComponent title="Vertical Input Form">
            <div className="flex flex-col gap-4">
              ...
              <div className="">
                <Button variant="default" className={cn("h-12 px-8")}>
                  Submit
                </Button>
              </div>
            </div>
              ...
              <div className="">
                ...
                <div className="relative">
                  <Input
                    type="text"
                    id="FirstNameTwoes"
                    className="border border-neutral-300 ps-12 pe-12 dark:border-slate-500 focus:border-primary dark:focus:border-primary focus-visible:border-primary h-12 rounded-lg !shadow-none !ring-0"
                    placeholder="First Name"
                  />
          ...
          <DefaultCardComponent title="Horizontal Input Form">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-5 sm:flex-nowrap flex-wrap">
                <Label
                  htmlFor="FirstNameee"
                  className="min-w-[110px] text-[#4b5563] dark:text-white mb-2"
                >
                  First Name{" "}
                </Label>
                <Input
