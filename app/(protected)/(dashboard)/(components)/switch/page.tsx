...
const TypographyPage = () => {
  ...
  const [inactiveSwitchHorizonta1, setinactiveSwitchHorizonta1] =
    useState(false);
  const [inactiveSwitchHorizonta2, setinactiveSwitchHorizonta2] =
    useState(false);
  const [inactiveSwitchHorizonta3, setinactiveSwitchHorizonta3] =
    useState(false);
  const [inactiveSwitchHorizonta4, setinactiveSwitchHorizonta4] =
    useState(false);
            ...
            <div className="flex items-center flex-wrap gap-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitch2 ? "text-purple-600 font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitch3 ? "text-green-600 font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitch4 ? "text-yellow-500 font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
            ...
            <div className="flex items-center flex-wrap gap-6">
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitchTwo1 ? "text-primary font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitchTwo2 ? "text-purple-600 font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitchTwo3 ? "text-green-600 font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label
                  ...
                  className={
                    inactiveSwitchTwo4 ? "text-yellow-500 font-medium" : ""
                  }
                >
                  Switch Inactive
                </Label>
          ...
          <div className="flex items-center flex-wrap gap-6">
            <div className="flex items-center space-x-2">
              ...
              <Label
                ...
                className={
                  inactiveSwitchHorizonta1 ? "text-primary font-medium" : ""
                }
              >
                Horizontal 1
              </Label>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label
                ...
                className={
                  inactiveSwitchHorizonta2 ? "text-purple-600 font-medium" : ""
                }
              >
                Horizontal 2
              </Label>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label
                ...
                className={
                  inactiveSwitchHorizonta3 ? "text-green-600 font-medium" : ""
                }
              >
                Horizontal 3
              </Label>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label
                ...
                className={
                  inactiveSwitchHorizonta4 ? "text-yellow-500 font-medium" : ""
                }
              >
                Horizontal 4
              </Label>
