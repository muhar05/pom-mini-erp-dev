      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <DefaultCardComponent title="Grouped Dropdown Buttons">
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex">
              <button
                className="text-white bg-primary hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-s-lg text-base px-5 py-4 text-center inline-flex items-center dark:bg-primary dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button"
              >
                1
              </button>
              <button
                className="text-white bg-primary hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-base px-5 py-4 text-center inline-flex items-center dark:bg-primary dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button"
              >
                2
              </button>
            ...
            <div className="flex">
              <button
                className="hover:bg-yellow-600 border hover:text-white border-yellow-600 text-yellow-600  focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-s-lg text-base px-5 py-4 text-center inline-flex items-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800"
                type="button"
              >
                1
              </button>
              <button
                className="hover:bg-yellow-600 border border-x-0 hover:text-white border-yellow-600 text-yellow-600  focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium text-base px-5 py-4 text-center inline-flex items-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800"
                type="button"
              >
                2
              </button>
