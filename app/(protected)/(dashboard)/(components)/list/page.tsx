      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <DefaultCardComponent title="Default List">
          <ul className="rounded-lg border border-slate-200 dark:border-slate-600 overflow-hidden">
            <li className="text-neutral-500 dark:text-neutral-300 p-4 bg-slate-50 dark:bg-slate-600 border-b border-slate-200 dark:border-slate-600">
            ...
            <li className="text-neutral-500 dark:text-neutral-300 p-4 bg-slate-50 dark:bg-slate-600">
        ...
        <DefaultCardComponent title="Active List">
          <ul className="rounded-lg border border-slate-200 dark:border-slate-600 overflow-hidden">
            <li className="text-neutral-500 dark:text-neutral-300 p-4 bg-primary border-b border-slate-200 dark:border-slate-600 text-white">
              1. This is list trust fund seitan letterpress, keytar raw denim
              keffiye
            </li>
            <li className="text-neutral-500 dark:text-neutral-300 p-4 bg-white dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600">
        ...
        <DefaultCardComponent title="List Icons & label">
          <ul className="rounded-lg border border-slate-200 dark:border-slate-600 overflow-hidden">
            <li className="flex items-center justify-between text-neutral-500 dark:text-neutral-300 p-4 bg-white dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600">
              ...
              <span className="text-xs bg-red-100 dark:bg-red-600/25 text-red-600 dark:text-red-400 rounded px-2.5 py-1 font-semibold">
                Low
              </span>
            </li>
            <li className="flex items-center justify-between text-neutral-500 dark:text-neutral-300 p-4 bg-white dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600">
              ...
              <span className="text-xs bg-green-100 dark:bg-green-600/25 text-green-600 dark:text-green-400 rounded px-2.5 py-1 font-semibold">
                High
              </span>
            </li>
            <li className="flex items-center justify-between text-neutral-500 dark:text-neutral-300 p-4 bg-white dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600">
              ...
              <span className="text-xs bg-purple-100 dark:bg-purple-600/25 text-purple-600 dark:text-purple-400 rounded px-2.5 py-1 font-semibold">
                Medium
              </span>
            </li>
            <li className="flex items-center justify-between text-neutral-500 dark:text-neutral-300 p-4 bg-white dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600">
