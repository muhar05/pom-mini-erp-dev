            ...
            <Tabs defaultValue="DefaultHome" className="gap-0">
              ...
              <div className="pt-6">
                <TabsContent value="DefaultHome" className="p-0">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-300 mb-0">
            ...
            <Tabs defaultValue="FocusHome" className="gap-0">
              <div className="flex items-center justify-between">
                <TabsList className="bg-transparent dark:bg-transparent rounded-none h-[50px]  p-0">
                  <TabsTrigger
                    value="FocusHome"
                    className="h-10 px-4 data-[state=active]:text-primary data-[state=active]:bg-primary/10 dark:data-[state=active]:bg-primary/20 duration-300 !shadow-none dark:text-white"
                  >
                    Home
                  </TabsTrigger>
                  <TabsTrigger
            ...
            <Tabs defaultValue="ButtonHome" className="gap-0">
              <div className="flex items-center justify-between">
                <TabsList className="bg-transparent dark:bg-transparent rounded-none h-[50px]  p-0">
                  <TabsTrigger
                    value="ButtonHome"
                    className="h-10 px-4 data-[state=active]:text-white data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white"
                  >
                    Home
                  </TabsTrigger>
                  <TabsTrigger
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="grow">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-300 mb-4">
                        ...
                        industry's standard dummy text ever since the 1400s,
          ...
          <DefaultCardComponent title="Icon Button Tabs">
            <Tabs defaultValue="VerticalNavHome" className="gap-0">
              <div className="flex items-center justify-between">
                <TabsList className="bg-transparent dark:bg-transparent rounded-none h-[50px]  p-0">
                  <TabsTrigger
                    value="VerticalNavHome"
                    className="h-10 px-4 data-[state=active]:text-white data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white flex items-center gap-2"
                  >
                    <Home className="w-4 h-4" />
                    Home
                  </TabsTrigger>
                  <TabsTrigger
                    value="VerticalNavDetails"
                    className="h-10 px-4 data-[state=active]:text-white data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white flex items-center gap-2"
                  >
            ...
            <Tabs defaultValue="IconButtonHome" className="gap-3 flex flex-row">
              <div className="shrink-0">
                <TabsList className="bg-transparent dark:bg-transparent rounded-none flex items-center justify-start flex-col p-0">
                  <TabsTrigger
                    value="IconButtonHome"
                    className="h-10 px-4 py-4 data-[state=active]:text-white w-full data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white"
                  >
                    Home
                  </TabsTrigger>
                  <TabsTrigger
                    value="IconButtonDetails"
                    className="h-10 px-4 py-4 data-[state=active]:text-white w-full data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white"
                  >
                    Details
                  </TabsTrigger>
                  <TabsTrigger
                    value="IconButtonProfile"
                    className="h-10 px-4 py-4 data-[state=active]:text-white w-full data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white"
                  >
                    Profile
                  </TabsTrigger>
                  <TabsTrigger
                    value="IconButtonSettings"
                    className="h-10 px-4 py-4 data-[state=active]:text-white w-full data-[state=active]:bg-primary dark:data-[state=active]:bg-primary !shadow-none dark:text-white"
                  >
                    Settings
                  </TabsTrigger>
          ...
          <Card className="card h-full !p-0 !block border-0 overflow-hidden">
            <Tabs defaultValue="CardHeaderHome" className="gap-0">
              <CardHeader className="flex items-center justify-between border-b border-neutral-200 dark:border-slate-600 !pb-0">
                ...
                <TabsList className="bg-transparent dark:bg-transparent rounded-none h-[50px]  p-0">
                  <TabsTrigger
                    value="CardHeaderHome"
                    className="py-2.5 px-4 font-medium text-base inline-flex items-center gap-3 dark:bg-transparent text-neutral-600 hover:text-primary dark:text-white dark:hover:text-blue-500 border-0 border-b-1 border-transparent dark:border-transparent data-[state=active]:text-primary dark:data-[state=active]:text-primary data-[state=active]:border-primary dark:data-[state=active]:border-primary dark:data-[state=active]:bg-transparent rounded-[0] data-[state=active]:shadow-none cursor-pointer translate-y-px"
                  >
                    Home
                  </TabsTrigger>
                  <TabsTrigger
                    value="CardHeaderDetails"
                    className="py-2.5 px-4 font-medium text-base inline-flex items-center gap-3 dark:bg-transparent text-neutral-600 hover:text-primary dark:text-white dark:hover:text-blue-500 border-0 border-b-1 border-transparent dark:border-transparent data-[state=active]:text-primary dark:data-[state=active]:text-primary data-[state=active]:border-primary dark:data-[state=active]:border-primary dark:data-[state=active]:bg-transparent rounded-[0] data-[state=active]:shadow-none cursor-pointer translate-y-px"
                  >
                    Details
                  </TabsTrigger>
                  <TabsTrigger
                    value="CardHeaderProfile"
                    className="py-2.5 px-4 font-medium text-base inline-flex items-center gap-3 dark:bg-transparent text-neutral-600 hover:text-primary dark:text-white dark:hover:text-blue-500 border-0 border-b-1 border-transparent dark:border-transparent data-[state=active]:text-primary dark:data-[state=active]:text-primary data-[state=active]:border-primary dark:data-[state=active]:border-primary dark:data-[state=active]:bg-transparent rounded-[0] data-[state=active]:shadow-none cursor-pointer translate-y-px"
                  >
                    Profile
                  </TabsTrigger>
                  <TabsTrigger
                    value="CardHeaderSettings"
                    className="py-2.5 px-4 font-medium text-base inline-flex items-center gap-3 dark:bg-transparent text-neutral-600 hover:text-primary dark:text-white dark:hover:text-blue-500 border-0 border-b-1 border-transparent dark:border-transparent data-[state=active]:text-primary dark:data-[state=active]:text-primary data-[state=active]:border-primary dark:data-[state=active]:border-primary dark:data-[state=active]:bg-transparent rounded-[0] data-[state=active]:shadow-none cursor-pointer translate-y-px"
                  >
                    Settings
                  </TabsTrigger>
