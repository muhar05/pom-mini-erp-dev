  ...
  const users = await prisma.users.createMany({
    data: [
      ...
      },
      {
        id: 8,
        name: "sales1",
        email: "sales1@ptpom.com",
        password_hash: "sales1",
        role_id: 2,
      ...
      },
      {
        id: 9,
        name: "sales2",
        email: "sales2@ptpom.com",
        password_hash: "sales2",
        role_id: 2,
        created_at: new Date("2026-01-23T00:00:00.000Z"),
      },
      {
        id: 10,
        name: "sales3",
        email: "sales3@ptpom.com",
        password_hash: "sales3",
        role_id: 2,
        created_at: new Date("2026-01-23T00:00:00.000Z"),
      },
      {
        id: 11,
        name: "purchasing1",
        email: "purchasing1@ptpom.com",
        password_hash: "purchasing1",
        role_id: 5,
        created_at: new Date("2026-01-23T00:00:00.000Z"),
      },
      {
        id: 12,
        name: "purchasing2",
        email: "purchasing2@ptpom.com",
        password_hash: "purchasing2",
        role_id: 5,
        created_at: new Date("2026-01-23T00:00:00.000Z"),
      },
      {
        id: 13,
        name: "manager_sales",
        email: "manager_sales@ptpom.com",
        password_hash: "manager_sales",
        role_id: 6,
        created_at: new Date("2026-01-23T00:00:00.000Z"),
      },
      {
        id: 14,
        name: "manager_purchasing",
        email: "manager_purchasing@ptpom.com",
        password_hash: "manager_purchasing",
        role_id: 5,
        created_at: new Date("2026-01-23T00:00:00.000Z"),
      },
    ],
